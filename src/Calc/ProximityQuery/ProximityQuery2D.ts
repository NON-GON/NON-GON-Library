...
export function characteristicPolynomial(
  ...
  const matrixA: number[][] = Array.from({ length: 3 }, () => Array(3).fill(0));
...
export function Ellipse_Ellipse_Caravantes(
  Ellipse1: any,
  Ellipse2: any
): boolean {
  const characteristicPolynomialValues = characteristicPolynomial(
    Ellipse1,
    Ellipse2
  );
...
export function Ellipse_Ellipse_Alberich(
  Ellipse1: Ellipse,
  Ellipse2: Ellipse
): boolean {
  const characteristicPolynomialValues = characteristicPolynomial(
